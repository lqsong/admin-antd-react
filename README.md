...
基于 React 、Ant Design 、TypeScript 、Axios ... 后台前端解决方案
...
基于 Vite + React 18 + Ant Design + Recoil 构建的 Admin

- [github](https://github.com/lqsong/admin-antd-react/tree/v2.0-vite)
- [gitee](https://gitee.com/lqsong/admin-antd-react/tree/v2.0-vite)
